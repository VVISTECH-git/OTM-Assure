...
function seed() {
  ...
  const sc02AllSteps = [
    ...
    [51, 'Add Gate_In tracking event',          'Gate_In (TMS.GI) event created successfully'],
    [52, 'Verify Gate_In in tracking events',   'Gate_In visible in View Tracking Events popup'],
    [53, 'Add Load_Start tracking event',       'Load_Start (TMS.LS) event created successfully'],
    [54, 'Verify Load_Start in tracking events','Load_Start visible in View Tracking Events popup'],
    [55, 'Add Load_End tracking event',         'Load_End (TMS.LE) event created successfully'],
    [56, 'Verify Load_End in tracking events',  'Load_End visible in View Tracking Events popup'],
    [57, 'Post PGI XML (HTTP 200)',             'PGI XML posted to WMServlet — HTTP 200 TransmissionAck'],
    [58, 'Add Gate_Out tracking event',         'Gate_Out (TMS.GO) event created successfully'],
    [59, 'Verify Gate_Out in tracking events',  'Gate_Out visible in View Tracking Events popup'],
    [60, 'Sign out LEL7597_TMS (end)',          'LEL7597_TMS signed out — end of SC-02'],
  ];
